<?php
/*
Template Name: Трипваер test-utils
...
<!-- КОНЕЦ Форма -->
		...
		<!-- Верстка новых блоков -->
<!-- Начало Квалифицированне лиды -->
		<section class="dark_section">
			<div class="wrap_section">
				...
				<div class="main_info_section">
					<div class="colomn_1">
						<div>
							<h4>Квалифицированные лиды от 1500 ₽:</h4>
							<p>Эффективный канал привлечения B2B клиентов.</p>
					...
					<div class="colomn_2">
						...
						<!-- <img src="<?php echo get_template_directory_uri().'/new-site/assets/images/malevich.png'; ?>" alt="description img"/> -->
					</div>
				...
				<div class="tariffs_content">
					...
					<div class="tariffs_block">
						...
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide">
								<div class="tariffs_card">
										<h3 class="fs_h3">Индивидуальный <span>Выгодно</span></h3>
										<ul>
										<li class="el_1">
											<p>&#10004;</p> 
										</li>
...
<!--Начало stages of work секция -->
		<section class="dark_section stages_of_work">
			<div class="wrap_section">
				<h2 class="fs_h2">Этап работ</h2>
				<div class="header_section_SOW descope">
					<div>
						<div class="stage fs_22_14 slide_1 swiper-slide-active">
							<span>1 Этап</span>
							<h5 class="fs_22_14">Бизнес аналитика клиента</h5>
						</div>
						<div class="stage fs_22_14 slide_2">
							<span>2 Этап</span>
							<h5 class="fs_22_14">Техническая настройка домена и почтовых ящиков</h5>
						</div>
						<div class="stage fs_22_14 slide_3">
							<span>3 Этап</span>
							<h5 class="fs_22_14">Сбор базы и написание цепочек писем</h5>
						</div>
						<div class="stage fs_22_14 slide_4">
							<span>4 Этап</span>
							<h5 class="fs_22_14">Запуск и реализация</h5>
						</div>
						<div class="stage fs_22_14 slide_5">
							<span>5 Этап</span>
							<h5 class="fs_22_14">Передача квалифицированных лидов</h5>
						</div>
					</div>
				</div>
				...
				<div class="swiper_SOW_content">
					<div class="swiper-wrapper">
						<!-- slide -->
						<div class="swiper-slide" data-slide="slide_1">
							<div class="content_SOW">
								<div>
									<h4>1. Бизнес аналитика клиента</h4>
									<p>Для определения стартовой точки проекта и триггеров роста в email-outreach мы проводим брифинг с клиентом.</p>
									<p>Во время брифинга мы:</p>
									<ul>
										<li>1. определяем цели и задачи. Обсуждаем основные цели email-outreach кампании, такие как привлечение новых клиентов, увеличение конверсий или повышение лояльности существующих клиентов;</li>
										<li>2. анализируем целевую аудиторию. Выясняем характеристики и предпочтения целевой аудитории, чтобы создать персонализированные и релевантные сообщения;</li>
										<li>3. обсуждаем ожидания клиента. Узнаем, какие результаты клиент ожидает от кампании, как он оценивает успех и какие KPI являются приоритетными.</li>
									</ul>
									<p>Этот анализ дает полное представление о текущем состоянии и помогает выстроить эффективную стратегию email-outreach, что способствует успешному запуску и росту кампаний.</p>
								</div>
								<div>
									<div class="visual_content">
						...
						<div class="swiper-slide" data-slide="slide_2">
							<div class="content_SOW">
								<div>
									<h4>2. Бизнес аналитика клиента</h4>
									<p>Для определения стартовой точки проекта и триггеров роста в email-outreach мы проводим брифинг с клиентом.</p>
									<p>Во время брифинга мы:</p>
									<ul>
										<li>1. определяем цели и задачи. Обсуждаем основные цели email-outreach кампании, такие как привлечение новых клиентов, увеличение конверсий или повышение лояльности существующих клиентов;</li>
						...
						<div class="swiper-slide" data-slide="slide_3">
							<div class="content_SOW">
								<div>
									<h4>3. Бизнес аналитика клиента</h4>
									<p>Для определения стартовой точки проекта и триггеров роста в email-outreach мы проводим брифинг с клиентом.</p>
									<p>Во время брифинга мы:</p>
									<ul>
										<li>1. определяем цели и задачи. Обсуждаем основные цели email-outreach кампании, такие как привлечение новых клиентов, увеличение конверсий или повышение лояльности существующих клиентов;</li>
						...
						<div class="swiper-slide" data-slide="slide_4">
							<div class="content_SOW">
								<div>
									<h4>4. Бизнес аналитика клиента</h4>
									<p>Для определения стартовой точки проекта и триггеров роста в email-outreach мы проводим брифинг с клиентом.</p>
									<p>Во время брифинга мы:</p>
									<ul>
										<li>1. определяем цели и задачи. Обсуждаем основные цели email-outreach кампании, такие как привлечение новых клиентов, увеличение конверсий или повышение лояльности существующих клиентов;</li>
						...
						<div class="swiper-slide" data-slide="slide_5">
							<div class="content_SOW">
								<div>
									<h4>5. Бизнес аналитика клиента</h4>
									<p>Для определения стартовой точки проекта и триггеров роста в email-outreach мы проводим брифинг с клиентом.</p>
									<p>Во время брифинга мы:</p>
									<ul>
										<li>1. определяем цели и задачи. Обсуждаем основные цели email-outreach кампании, такие как привлечение новых клиентов, увеличение конверсий или повышение лояльности существующих клиентов;</li>
