        ...
        <header class="header portfolio__header marketing__header">
			<div class="container">
				<h1 class="titlePage header__title">
					Блог про контент-<br /> <span>маркетинг</span>
				</h1>
			</div>
		</header>
					...
					<section class="portfolio__main-section case marketing">
						<div class="case__tabs marketing__tabs">
                            ...
                            <?php
                                ...
                                $post_ids = get_objects_in_term( $idTax, 'category' );
                                ...
                                <?php foreach( $tags as $tag ) { ?>
                                    <a href="<?php echo get_term_link( $tag, 'post_tag' ); ?>" class="case__btn-tab marketing__content-tab radius_1"><?php echo $tag->name; ?></a></li>
                                <?php } ?>
                                <?php } ?>
                            <?php } ?>
							</div>
